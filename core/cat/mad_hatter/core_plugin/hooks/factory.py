...
from cat.factory.uploader import UploaderConfig
...
@hook(priority=0)
def factory_allowed_uploaders(allowed: List[UploaderConfig], cat) -> List:
    """Hook to extend list of supported uploaders.

    Args:
        allowed : List of UploaderConfig classes
            list of allowed uploaders
        cat : CheshireCat
            Cheshire Cat instance

    Returns:
        supported : List of UploaderConfig classes
            list of allowed uploaders
    """
