...
class MadHatter(HumptyDumpty):
    """
    Mad Hatter is the plugin manager of the various instance of Cheshire Cat. It is responsible for:
    ...
    def find_plugins(self):
        # plugins are already loaded when BillTheLizard is created, since its MarchHare scans the plugins folder
        # then, we just need to grab the plugins from there
        self.plugins = self.march_hare.plugins
