...
class ConnectionAuth(ABC):
    ...
    @abstractmethod
    async def extract_credentials(self, connection: HTTPConnection) -> Tuple[str] | None:
        pass

    @abstractmethod
    async def get_user_stray(self, user: AuthUserInfo, connection: HTTPConnection) -> StrayCat:
        pass
